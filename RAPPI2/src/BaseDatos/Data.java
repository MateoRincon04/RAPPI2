...
public class Data {
	...
	public static final void CargarOpciones() {
		...
		opciones.add(new cambiarContrase�aTendero()); //13 tendero
		...
		opciones.add(new cambiarContrase�aRestaurante()); // 21 restaurante
		...
		opciones.add(new cambiarContrase�aAdmin()); //28 Admin
	...
	private static final String filepathPedido = "RAPPI2\\src\\BaseDatos\\temp\\"
			+ "pedidoGuardados.json";
	private static final String filepathCliente = "RAPPI2\\src\\BaseDatos\\temp\\"
			+ "clientesGuardados.json";
	private static final String filepathTendero = "RAPPI2\\src\\BaseDatos\\temp\\"
			+ "tenderosGuardados.json";
	private static final String filepathAdministrador = "RAPPI2\\src\\BaseDatos\\temp\\"
			+ "administradoresGuardados.json";
	private static final String filepathRestaurantes = "RAPPI2\\src\\BaseDatos\\temp\\"
			+ "restaurantesGuardados.json";
	private static final String filepathPlato = "RAPPI2\\src\\BaseDatos\\temp\\"
			+ "platosGuardados.json";
	static final String filepathNotificacion = "RAPPI2\\src\\BaseDatos\\temp\\"
	...
	/**
	 * Metodo para buscar un usuario en la base de datos de Cliente usando
	 * solo el userName
	 * 
	 * @see: {@link #traerDataBaseCliente()}
	 */
	 ...
	 * 
	 * @param administrador El parametro define el cliente que va a ser
	 *                      actualizado
	 */
	...
	//metodos en RAM para Pedido
		...
		/**
		 * Metodo para buscar un usuario en la base de datos de Pedido usando
		 * solo el ID
		 * 
		 ...
		 * 
		 * @param administrador El parametro define el Pedido que va a ser
		 *                      actualizado
		 */
		...
		//metodos en RAM para Tendero
			...
			/**
			 * Metodo para buscar un usuario en la base de datos de Tendero usando
			 * solo el userName
			 * 
			 * @see: {@link #traerDataBaseTendero()}
			 */
			 ...
			 * 
			 * @param administrador El parametro define el tendero que va a ser
			 *                      actualizado
			 */
			...
			/**
			 * Metodo para buscar un Plato en la base de datos de Platos usando
			 * solo el nombre
			 * 
			 * @see: {@link #traerDataBasePlato()}
			 */
			...
			/**
			 * Metodo que lee la base de datos de Platos desde su file y obtiene los
			 * objetos alli guardados
			 */
			...
			//metodos en RAM para Calificacion
				...
				/**
				 * Metodo para buscar un usuario en la base de datos de Calificacion usando
				 * solo el ID
				 * 
				 * @see: {@link #traerDataBasePedido()}
				 */
