...
/*
 * debo crear una clase por cada funcionalidad. Creo una lista que contenga los
 * objetos (funcionalidades) para ejecutar. Luego el usuario pide la acci�n
 * por numeros. le resto uno y tengo el indice de la acci�n en la lista. debo
 * crear una clase por cada acci�n para que por ligadura din�mica, se
 * ejecute el metodo ejecutar de cada clase. cumpliendo as� lo que busca el
 * usuario. opcion de menu debe ser padre de todas las clases que heredan.
 */